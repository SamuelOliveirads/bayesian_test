...
# bayesian_project documentation build
...
from bayesian_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "bayesian_project"
author = "Kedro"
...
htmlhelp_basename = "bayesian_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "bayesian_project.tex",
        "bayesian_project Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "bayesian_project",
        "Project bayesian_project codebase.",
        "Nearest-Neighbour",
    )
]
